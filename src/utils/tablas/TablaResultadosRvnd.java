...
public class TablaResultadosRvnd extends TablaResultadosBase {

    @Override
    public String titulo() {
        return "TABLA 12: RESULTADOS RVND (ALTERNATIVA A GVNS)";
    }

    @Override
    protected String[] header() {
        return new String[] {"Instancia", "Ejec.", "|Jopen|", "C. Fijo", "C. Asig.", "C. Total", "Incomp.", "CPU_Time (s)"};
    }

    public void addResultado(String instancia, int ejec, Solucion sol, long tiempoMs) {
